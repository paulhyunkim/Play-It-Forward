...
describe Song do
  ...
  before do 
  	...
  	@without_title = Song.create(artist: "Katy Perry", duration: 9384, key:"t16055713", album: "null", is_explicit: "null", image_url:"null")
  	@without_key = Song.create(artist: "Miley Cyrus", title: "We Can't Stop", duration: 231, album: "Bangerz", is_explicit: "false", image_url:"null")
	end
	...
	it "should not save a song without a title" do
		expect(@without_title).to_not be_valid
	end

	it "should not save a song without a key" do
		expect(@without_key).to_not be_valid
	end
